...
*/        
  public function sign($args=array()) 
  {
    ...
    $queryString = $this->_normalizedParameters(false);
...
*/
  ...
  public static function _oauthEscape($string) 
  {
  ...
  private function _normalizedParameters($includeOAuth=true) 
  {
    ...
    {
      if ($includeOAuth OR strpos($key, 'oauth_') !== 0) {
        if (is_array($val)) 
        {
          sort($val);
